...
o1 = [((x_max-bl)/2) -10e-9];
o2 = [((x_max-bl)/2) (y_max - bw)]; 

box1 = Obstruction(o1, bl, bw + 10e-9, 0);
box2 = Obstruction(o2, bl, bw + 10e-9, 0);
...
pbaspect([2 1 1])
view([1 -2 2])
xlim([1 (ceil(x_max/ds)+1)]);
ylim([1 (ceil(y_max/ds)+1)]);
xlabel('x (m)');
ylabel('y (m)');
zlabel('V');
